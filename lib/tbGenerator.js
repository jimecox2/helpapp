...
PLACEMENT: every Risk row has tbType "Task", tbSubType "Risk", tbSelfKey2 = the L2 Project's tbID (directly under the Project), tbWork 0. Risk rows come LAST in the tbTimebars array, after all work rows. Dates: copy the Project's tbStart, tbFinish and tbDuration onto every Risk unless the source states a date for that risk (a review or closure date becomes tbFinish).
