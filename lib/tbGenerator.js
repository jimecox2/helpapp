...
PER-RISK FIELDS — tbTimebars row: tbID = project prefix + "_R" + sequence starting at 10 (e.g. "CRM_R10"), tbName = concise risk title under 150 chars, tbOwner = the named risk owner when stated. On the risk's tbMetaData record (leave out when the source says nothing):
- tbMDNotes: the full risk statement as written
- tbMDProbability: EXACTLY one of: Very Unlikely, Unlikely, Likely, Very Likely, Certain — translate wording ("almost certain" -> Certain, "low chance" -> Unlikely). "Not Assessed" if no likelihood is given.
